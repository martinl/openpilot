...
class CarControllerParams:
  def __init__(self, CP):
    if CP.carFingerprint in [ CAR.IMPREZA_2020 ]:
      self.STEER_MAX = 1439
    else:
      self.STEER_MAX = 2047
...
class CAR:
  ...
  IMPREZA_2020 = "SUBARU IMPREZA 2020"
...
FINGERPRINTS = {
  ...
  CAR.IMPREZA_2020: [{
    # Impreza 2020 - TODO get a proper fingerprint
    2101: 8
  }],
  ...
  #CAR.FORESTER_HYBRID: [{
  #  TODO: Get a proper v1 fingerprint for the forester hybrid, this is still used to get a list of all cars in test validations
  #  4321: 8
  #}],
}

# Use only FPv2
IGNORED_FINGERPRINTS = [CAR.IMPREZA, CAR.IMPREZA_2020, CAR.ASCENT, CAR.FORESTER_HYBRID ]
...
FW_VERSIONS = {
  ...
  CAR.IMPREZA_2020: {
    # Torque restricted Impreza/Crosstrek
